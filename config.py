...
OWNER_NAME = getenv("OWNER_NAME", "Dora")
OWNER_USERNAME = getenv("OWNER_USERNAME", "P_4_PEEYUSH")
ALIVE_NAME = getenv("ALIVE_NAME", "Dora")
BOT_USERNAME = getenv("BOT_USERNAME", "Dora2_Robot")
OWNER_ID = getenv("OWNER_ID", "6439075095")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Dora2_Assistant")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ITZ-Dora/Dora-Vc-Player")
